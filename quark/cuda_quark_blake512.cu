...
/*
// Endian Drehung fr 64 Bit Typen
...
__global__ __launch_bounds__(256, 2) void quark_blake512_gpu_hash_64(int threads, uint32_t startNounce, uint32_t *g_nonceVector, uint64_t *g_hash)
{
	...
	const int warpBlockID = (thread + 15)>>4; // aufrunden auf volle Warp-BlíµŠíº¥
...
#pragma unroll 8
		...
		// Hash rauslassen
#if __CUDA_ARCH__ >= 130
		// ausschliesslich 32 bit Operationen sofern die SM1.3 double intrinsics verfgbar sind
...
// Blake512 fr 80 Byte grosse Eingangsdaten
