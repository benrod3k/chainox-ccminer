...
// der Versuch, einen Wrapper fr einen aus 32 Bit Registern zusammengesetzten uin64_t Typen zu entferfen...
#if 1
...
#pragma unroll 6
        ...
        // Padding einfgen (Byteorder?!?)
        message[8] = SPH_C64(0x80);
        // Lã­§e (in Bits, d.h. 64 Byte * 8 = 512 Bits
...
// Bmw512 fr 80 Byte grosse Eingangsdaten
__host__ void quark_bmw512_cpu_setBlock_80(void *pdata)
{
	...
	// Lã­§e (in Bits, d.h. 80 Byte * 8 = 640 Bits
