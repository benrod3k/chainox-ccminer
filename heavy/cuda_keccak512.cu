...
// die Message (72 Bytes) fr die zweite Runde auf der GPU
...
#pragma unroll 25
		...
		// den Block einmal gut durchschtteln
	...
	// heftyHash hat 32-Byte
{
	...
	// keccak hat 72-Byte blíµŠíº¥, d.h. in unserem Fall zwei BlíµŠíº¥
	// zu jeweils 
	uint32_t msgBlock[18];
